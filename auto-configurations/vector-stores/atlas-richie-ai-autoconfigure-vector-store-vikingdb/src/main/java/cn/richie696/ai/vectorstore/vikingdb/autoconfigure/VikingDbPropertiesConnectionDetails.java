...
final class VikingDbPropertiesConnectionDetails implements VikingDbConnectionDetails {
    ...
    @Override public String getHost() { return properties.getHost(); }

    /** @return 来自 {@link VikingDbClientProperties#getControlEndpoint()} 的控制面 endpoint。 */
    @Override public String getControlEndpoint() { return properties.getControlEndpoint(); }

    /** @return 来自 {@link VikingDbClientProperties#getRegion()} 的区域。 */
    @Override public String getRegion() { return properties.getRegion(); }

    /** @return 来自 {@link VikingDbClientProperties#getAccessKey()} 的访问密钥。 */
    @Override public String getAccessKey() { return properties.getAccessKey(); }

    /** @return 来自 {@link VikingDbClientProperties#getSecretKey()} 的密钥。 */
    @Override public String getSecretKey() { return properties.getSecretKey(); }

    /** @return 来自 {@link VikingDbClientProperties#getScheme()} 的协议名称。 */
    @Override public String getScheme() { return properties.getScheme(); }
}