...
public interface VikingDbConnectionDetails extends ConnectionDetails {
    ...
    /**
     * Data-plane authentication mode. Existing implementations default to AK/SK.
     */
    default VikingDbAuthenticationMode getAuthenticationMode() {
        return VikingDbAuthenticationMode.AK_SK;
    }

    /**
     * Data-plane API key; null when AK/SK authentication is used.
     */
    ...
    default long getConnectTimeoutMs() {
        return 10_000L;
    }
    ...
    default long getWriteTimeoutMs() {
        return 30_000L;
    }
}
